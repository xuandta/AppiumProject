...
public class P2_Register extends MyActions{
    ...
    public P2_Register(AppiumDriver driver) {
    	super(driver);
   ...
   public void fullfillregisterBtn(AppiumDriver<MobileElement> driver, String email, String name,String phone, String password) {
